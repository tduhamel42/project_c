...
** Last update Sun Apr 10 15:26:07 2016 tanguy duhamel
*/
...
int		delete_elem(t_llist *elem, int (*func)());
...
t_variable	*get_variable(char *str_variable, char sep);
char		*get_variable_name(char *str_variable, char sep);
char		*get_varible_value(char *str_variable, char sep);
int		free_variable(t_variable *variable);
